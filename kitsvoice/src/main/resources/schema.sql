...
create table action_element(id bigint auto_increment,caller_Sid varchar(50),intent varchar(50),action varchar(500),parameter varchar(500));
create table memory_stick(id bigint auto_increment,caller_Sid varchar(50),variable varchar(50),value varchar(500));
